...
NavTools 专为 Cloudflare Workers 平台设计，提供全球边缘计算能力和优秀的性能表现。本页面介绍部署的基本概念和快速入门。
...
[查看详细步骤 →](/deployment/custom-domain)
...
```
Published navtools (1.23 sec)
  https://navtools.your-subdomain.workers.dev
```
...
| `name` | navtools | Workers 脚本名称 |
| `compatibility_date` | 2024-01-01 | Cloudflare 兼容性日期 |

详细配置说明请参考 [配置文档](/deployment/configuration)。
...
更多问题解决方案请参考 [常见问题](/guide/faq)。

## 下一步

部署完成后，您可以：

- [配置环境变量](/deployment/configuration) - 详细的配置选项说明
- [使用自定义域名](/deployment/custom-domain) - 绑定您的域名
- [了解安全最佳实践](/security/) - 增强系统安全性
- [自定义样式](/features/customization) - 个性化外观
- [导入数据](/features/data-management) - 批量添加站点
